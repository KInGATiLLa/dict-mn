...
```
Уг толь нь hunspell алдаа шалгагчийн 1.3.3-аас хойших хувилбаруудад зориулагдсан.
```

[Firefox](https://www.mozilla.org/en-US/firefox/new/) болон [LibreOffice](https://www.libreoffice.org/) дээр түгээмэл ашиглагдаж байгаа төдийгүй [hunspell](http://hunspell.github.io/) дэмждэг дурын программд энэхүү толийг ашиглаж боломжтой. Тэдгээрийн заримаас дурдвал:
1. .NET
1. Chrome
1. Chromium
1. Emacs
